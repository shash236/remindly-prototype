...
import com.remindly.api.chat.constants.RoleEnum;
...
public class RemindlyChatServiceImpl implements ChatService {
    ...
    public InitiateChatResult initiateChat(InitiateChatCommand command) {
        ...
        return InitiateChatResult.builder()
                .chatId(chat.getId())
                .message(firstAssistantMessage.getContent())
                .build();
    }
    ...
    public ChatResult respond(ChatCommand chatCommand) {
        ...
        Message userMessage = Message.builder()
                ...
                .content(chatCommand.getMessage())
        ...
        while (isToolCall) {
            ...
            String toolKey = generateResult.getToolCallDto().getToolName();
            ToolHandler toolHandler = toolHandlerRegistry.getToolHandler(toolKey);
            String toolResult = toolHandler.callTool(generateResult.getToolCallDto());
